...
class AWPCP_Search_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($instance['show_keyword'] == 1) {
			...
			echo '<input style="max-width:180px;" id="awpcp-search-keywordphrase" type="text" name="keywordphrase" value="' . esc_attr($keywordphrase) . '" class="alignleft">';
		}
		...
		echo '<div class="submit"><input class="button" type="submit" value="Buscar"></div>';
        echo '</form></div>';
        echo '</div>';
		echo $after_widget;
	}
