<?php
/*
Plugin Name: Doap Language Translator
Plugin URI: http://www.doap.com/plugins/dlt
Version: 4.0.9
Description: A language translation module for Doap
Author: Doap
...
class google_language_translator {
  ...
  public function __construct() {
    ...
    add_shortcode( 'doap-translator',array(&$this, 'google_translator_shortcode'));
  ...
  public function add_my_admin_menus(){
    $p = add_options_page('Doap Language Translator', 'Doap Language Translator', 'manage_options', 'google_language_translator', array(&$this, 'page_layout_cb'));
    ...
    include( plugin_dir_path( __FILE__ ) . '/css/style.php'); ?>
        ...
        <div class="wrap">
	      <div id="icon-options-general" class="icon32"></div>
	        <h2><span class="notranslate">Doap Language Translator</span></h2>
		      <form action="<?php echo admin_url('options.php'); ?>" method="post">
	          <div class="metabox-holder has-right-sidebar" style="float:left; width:65%">
                <div class="postbox" style="width: 100%">
<img src="http://doap.com/wp-content/uploads/2014/12/doap-logo-hires-big.png" style="padding-right:120px;padding-top:10px;" width="150" class="alignright" height="50" alt="DevOps and Platforms">
                  <h3 class="notranslate">DevOps and Platforms</h3><p style="padding-left:10px;position:relative;top:-15px;">As an Amazon MSP, we fully manage customers’ AWS-based infrastructure, associated databases, and applications.</p>
			      ...
			      <?php settings_fields('google_language_translator'); ?>
                    <table style="border-collapse:separate" width="100%" border="0" cellspacing="8" cellpadding="0" class="form-table">
					  ...
					  <tr class="notranslate">
				        <td class="choose_flags_intro">Show flag images?<br/></td>
		  ...
		  <div id="glt_advanced_settings" class="metabox-holder notranslate" style="float: right; width: 33%;display:none;">
          <div class="postbox">
			<div class="inside">
			    <table style="border-collapse:separate" width="100%" border="0" cellspacing="8" cellpadding="0" class="form-table">
				      <tr class="notranslate">
						<td class="advanced" style="display:none;"><?php $this->googlelanguagetranslator_flag_size_cb(); ?>
<select name="googlelanguagetranslator_flag_size" id="googlelanguagetranslator_flag_size" style="width:110px;">
