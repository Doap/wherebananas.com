...
if ( ! function_exists( 'et_setup_theme' ) ){
	function et_setup_theme(){
		...
		//remove 'add to cart' button from products
		remove_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10 );

		remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10 );
		add_action( 'woocommerce_before_main_content', 'et_styleshop_output_content_wrapper', 10 );

		remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10 );
		add_action( 'woocommerce_after_main_content', 'et_styleshop_output_content_wrapper_end', 10 );
...
if ( class_exists( 'woocommerce' ) ) :
	...
	if ( 'false' !== et_get_option( 'styleshop_show_checkout_button', 'on' ) ) {
?>
...
function et_styleshop_output_content_wrapper_end() {
	echo '
			<div class="clear"></div>
		</div> <!-- #main-area -->';
...
function et_styleshop_loop_shop_columns( $columns ) {
	return 3;
}
add_filter( 'loop_shop_columns', 'et_styleshop_loop_shop_columns' );
